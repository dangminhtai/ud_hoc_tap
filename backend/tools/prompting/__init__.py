...
from backend.core.tool_protocol import ToolAlias, ToolPromptHints
...
class ToolPromptComposer:
    ...
    def format_list(self, hints: list[ToolHintEntry], kb_name: str = "") -> str:
        """Format list and return a string."""
        lines: list[str] = []
    ...
    def format_table(
        ...
        """Format table and return a string."""
        parts: list[str] = []
        table_lines = [
    ...
    def format_aliases(self, hints: list[ToolHintEntry]) -> str:
        """Format aliases and return a string."""
        lines: list[str] = []
        for name, hint in hints:
            if hint.aliases:
    ...
    def format_phased(self, hints: list[ToolHintEntry]) -> str:
        """Format phased and return a string."""
