...
from backend.core.trace import merge_trace_metadata


class DeepQuestionCapability(BaseCapability):
    """Deep question capability class."""
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        """Run."""
        from backend.agents.question.coordinator import AgentCoordinator
        ...
        if isinstance(followup_question_context, dict) and followup_question_context.get(
            ...
            from backend.agents.question.agents.followup_agent import FollowupAgent
