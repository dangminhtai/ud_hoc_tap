...
from backend.core.trace import derive_trace_metadata, merge_trace_metadata, new_call_id


class DeepResearchCapability(BaseCapability):
    """Deep research capability class."""
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        """Run."""
        from backend.agents.research.research_pipeline import ResearchPipeline
        from backend.agents.research.request_config import (
            build_research_runtime_config,
            validate_research_request_config,
        )
        from backend.services.config import load_config_with_main
