...
from backend.core.trace import derive_trace_metadata, merge_trace_metadata


class DeepSolveCapability(BaseCapability):
    """Deep solve capability class."""
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        """Run."""
        from backend.agents.solve.main_solver import MainSolver
