...
from backend.core.capability_protocol import BaseCapability
from backend.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("backend.plugins.loader")
    except Exception:
...
class CapabilityRegistry:
    ...
    def list_capabilities(self) -> list[str]:
        """Trả về danh sách các capabilities"""
