...
cloud_provider = import_module("backend.services.llm.cloud_provider")
local_provider = import_module("backend.services.llm.local_provider")
...
class RoutingProvider(BaseLLMProvider):
    ...
    async def complete(self, prompt: str, **kwargs: object) -> TutorResponse:
        ...
        async def _call() -> str:
            ...
            if cache_enabled:
                try:
                    module = import_module("backend.services.llm.cache")
