...
from backend.services.session import get_sqlite_session_store

router = APIRouter()


class SessionRenameRequest(BaseModel):
    """Session rename request class."""
    title: str = Field(..., min_length=1, max_length=100)


class QuizResultItem(BaseModel):
    """Quiz result item class."""
    question_id: str = ""
