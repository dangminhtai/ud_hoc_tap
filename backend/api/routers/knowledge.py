...
from backend.api.utils.progress_broadcaster import ProgressBroadcaster
from backend.api.utils.task_id_manager import TaskIDManager
from backend.api.utils.task_log_stream import capture_task_logs, get_task_stream_manager
from backend.knowledge.add_documents import DocumentAdder
from backend.knowledge.initializer import KnowledgeBaseInitializer
from backend.knowledge.manager import KnowledgeBaseManager
from backend.knowledge.progress_tracker import ProgressStage, ProgressTracker
from backend.services.rag.components.routing import FileTypeRouter
from backend.services.rag.factory import DEFAULT_PROVIDER, has_pipeline, normalize_provider_name
...
async def get_all_kb_configs():
    ...
    try:
        from backend.services.config import get_kb_config_service
